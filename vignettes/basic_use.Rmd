...
# Search for journal articles by RD Treede that contain the word "pain" and 
# which were published between 1 January 2000 and 31 December 2018
df <- get_records(search_terms = "Treede RD[AU] AND pain",
            min_date = '2000/01/01',
            max_date = '2018/12/31',
            has_abstract = TRUE,
...
#### Fourth, strip out the top 50 2-ngrams and plot

```{r plot}
word_cloud <- ngram_count[1:200, ] %>% 
  rename(freq = n)
